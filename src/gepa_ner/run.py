...
def run_evolution(
    ...
    *,
    ...
    wandb_run_name : str | None
        Optional wandb run name.  ``None`` = auto-generated.
    ...
    wandb.init(
        ...
        config={
            ...
            "bert_batch_size": bert_batch_size,
            "baseline_epochs": baseline_epochs,
            "baseline_relaxed_f1": adapter._baseline_relaxed_f1,
            "synth_dataset_size": synth_dataset_size,
    ...
    wandb.summary["best_val_score"] = best_score
    wandb.finish()
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument(
        "--wandb-project", default="gepa-ner",
        help="Weights & Biases project name (default: gepa-ner).",
    )
    parser.add_argument(
